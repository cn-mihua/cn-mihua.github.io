...
function bot_ui_ini() {
    ...
    secondpart = function() {
        botui.message.add({
            ...
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1200,
                    content: "兴趣广泛，软件，硬件，古典文学，埙，文鸟，厨艺都有涉猎"
                }).then(function() {
                    botui.message.add({
                        delay: 1500,
    ...
    thirdpart = function() {
        botui.message.add({
            delay: 1e3,
            content: "我们应该，成为自己想成为的人;而不是，成为别人想要你成为的人。。。"
        }).then(function() {
            botui.action.button({
                delay: 1500,
                action: [{
    ...
    fourthpart = function() {
        botui.message.add({
            delay: 1e3,
            content: "米花来自名侦探柯南里面的柯南居住地米花町 "
        }).then(function() {
            botui.message.add({
                delay: 1100,
                content: "Aye来自古英语，意思是：是，对，总是，仍然"
            }).then(function() {
                botui.action.button({
                    delay: 1500,
                    action: [{
    ...
    fifthpart = function() {
        botui.message.add({
            delay: 1e3,
            content: "emmmmm，本姓周，251跟我名字缩写很像。。。"
        }).then(function() {
            botui.message.add({
                delay: 1600,
                content: "那么，相遇就是缘分，希望你万事如意 ^_^"
            })
        })
    }
}
